...
export default function Dashboard() {
  ...
  const statCards = [
    { title: 'Total Cars', value: stats?.totalCars || 0, icon: FaCar, color: 'primary', to: '/cars' },
    { title: 'Total Bookings', value: stats?.totalBookings || 0, icon: FaBook, color: 'green', to: '/bookings' },
    { title: 'Total Users', value: stats?.totalUsers || 0, icon: FaUsers, color: 'blue', to: '/users' },
    { title: 'Revenue', value: `$${stats?.revenue || 0}`, icon: FaDollarSign, color: 'purple' }, // no link
  ];

  const dailyBookings = stats?.dailyBookings || [];
